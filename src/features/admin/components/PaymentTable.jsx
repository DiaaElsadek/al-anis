          ...
          <Table className="text-xs text-start">
            <TableHeader className="bg-muted/50 text-muted-foreground text-xs uppercase tracking-wider font-semibold">
              <TableRow className="border-b">
                ...
                <TableHead className="px-5 py-3.5 text-start">{t("admin:payments.date")}</TableHead>
                <TableHead className="px-5 py-3.5 text-end">{t("admin:payments.amount")}</TableHead>
                <TableHead className="px-5 py-3.5 text-center">
