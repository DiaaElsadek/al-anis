        ...
        <Tabs value={selectedShift} onValueChange={setSelectedShift} className="w-full">
          <div className="flex justify-center">
            <TabsList className="h-12 p-1 rounded-xl bg-card border border-border/70 shadow-xs grid grid-cols-3 max-w-md w-full">
              <TabsTrigger
                value="morning"
                className="rounded-lg text-xs sm:text-sm font-semibold gap-1.5 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground"
              >
                  ...
                  <div className="p-6 sm:p-8 grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                    <div className="space-y-5 lg:col-span-2">
                      <div className="flex items-center gap-3">
                        <div
                          className={`p-3 rounded-xl ${activeShift.bg} ${activeShift.color} border ${activeShift.border}`}
                        >
                          <activeShift.icon className="h-7 w-7" />
                        </div>
                        <div>
                        ...
                        <span className="ms-auto text-xs bg-muted text-foreground/80 px-2.5 py-1 rounded-md">
                          {activeShift.badge}
                        </span>
                      </div>
